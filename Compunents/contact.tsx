    ...
    return(
        ...
        <div className="md:pt-30 xl:px-50 pt-30 px-5 md:px-20">
            ...
            <main className="grid md:grid-cols-2 gap-10 md:gap-30 m-auto justify-center">
                ...
                <div>
                    <p className='p-5'>
                        <a href="mailto:ajayisamsontobi17@gmail.com?subject=Project%20Inquiry" target='_blank' >
                    ...
                    <p className='p-5'>
                        <a href="https://wa.me/2348138172952" target='_blank'>
                        <button className='gap-2 w-full cursor-pointer flex text-center hover:bg-green-700 border-3 py-2 rounded border-foreground bg-green-500 px-4 md:w-50 text-background justify-center'>Message me on
