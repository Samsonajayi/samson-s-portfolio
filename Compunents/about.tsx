...
export function AboutPage() {
  return (
    <div className="md:py-30 xl:px-50 pt-30 px-5 md:px-20">
      ...
      <main className="grid md:grid-cols-2 justify-center m-auto">
        <div className=" w-full ">
        <p className="leading-8 text-2xl pt-20">
        ...
        <p className="text-2xl pt-15 leading-8">Currently exploring the mobile app development feild, and i'm always open to collaborations and learning new things in the ever-evolving world of technology.
